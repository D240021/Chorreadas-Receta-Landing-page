    ...
    addUser(user)
      .then(() => {
        ...
        setFormStatus({
          ...
          error: false,
          message:
            "¡Gracias por registrarse! Recibirá nuestras recetas y novedades en su correo electrónico.",
        });
      })
      .catch((error) => {
        ...
        setFormStatus({
          ...
          error: true,
          message:
            "Ocurrió un error al registrar su información. Por favor, inténtelo de nuevo más tarde.",
        });
      });

  };
  return (
    <section id="register" className="py-20 bg-amber-50 w-full">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {formStatus.submitted ? (
            ...
            >
              ...
              <button
                type="submit"
                className="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 px-6 rounded-lg transition-colors transform hover:scale-105"
              >
                Registrarse
              </button>
